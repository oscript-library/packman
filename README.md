...
* Использовать существующую ИБ в качестве рабочей
...
При использовании существующей ИБ в качестве рабочей (например, формирование поставки непосредственно с тестового контура), будьте внимательны при использовании команд выгрузки из хранилища, а так же снятия с поддержки, так эти действия необратимы.
