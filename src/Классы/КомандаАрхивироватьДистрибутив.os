...
Процедура ЗарегистрироватьКоманду(Знач ИмяКоманды, Знач Парсер) Экспорт
    ...
    Парсер.ДобавитьПозиционныйПараметрКоманды(ОписаниеКоманды, "КаталогДистрибутива", "Путь к каталогу дистрибутива");
...
Функция ВыполнитьКоманду(Знач ПараметрыКоманды) Экспорт
	...
	КаталогДляАрхивации = ПараметрыКоманды["КаталогДистрибутива"];
    Если Не ЗначениеЗаполнено(КаталогДляАрхивации) Тогда
        ВызватьИсключение "Должен быть указан каталог с файлами дистрибутива";
    КонецЕсли;
